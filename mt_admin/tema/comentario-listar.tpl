...
<div class="bg-gris">
    <div class="container cont-750">
        <ul class="nav-hor nav-sec">
          <li class="active"><a href="comentario">Comentarios</a></li>
    ...
    <div class="container art-row-cont">
        ...
        <div class="art-row">
            ...
            <div class="gd-20 tx-der">
      			<a class="bta icon-eye" target="_blank" title="Ver Página" href="{url}"></a>
      			<a class="bta icon-pencil" title="Editar Artículo" href="comentario?accion=editar&id={id}"></a>
      			<a class="bta icon-cross" title="Eliminar Artículo" href="comentario?accion=eliminar&id={id}"></a>
            </div>
        </div>
		{/lista_comentarios}
    </div>
